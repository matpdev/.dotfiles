...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    _tabId() {
      var $async$goto = 0,
        ...
        $async$returnValue, tab;
      var $async$_tabId = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 3;
              return A._asyncAwait(A.activeTab(), $async$_tabId);
            case 3:
              // returning from await.
              tab = $async$result;
              $async$returnValue = tab == null ? null : J.get$id$x(tab);
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$_tabId, $async$completer);
    },
    main() {
      var $async$goto = 0,
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$goto = 2;
              return A._asyncAwait(A._loadUiAndHideSpinner(), $async$main);
            case 2:
              // returning from await.
              // implicit return
    ...
    _registerListeners() {
      var windowOption, tabOption, _s5_ = "click",
        t1 = document,
        t2 = type$.ButtonElement;
      B.ButtonElement_methods.addEventListener$2(t2._as(t1.getElementById("launchDevToolsButton")), _s5_, A.popup___launchDevTools$closure());
      B.ButtonElement_methods.addEventListener$2(t2._as(t1.getElementById("copyIdButton")), _s5_, A.popup___copyAppId$closure());
      B.ButtonElement_methods.addEventListener$2(t2._as(t1.getElementById("fileBugButton")), _s5_, A.popup___openIssueTracker$closure());
      B.HtmlDocument_methods.addEventListener$2(t1, "DOMContentLoaded", A.popup___updateSettingsFromStorage$closure());
      t2 = type$.InputElement;
      windowOption = t2._as(t1.getElementById("windowOption"));
      B.InputElement_methods.addEventListener$2(windowOption, "change", new A._registerListeners_closure(windowOption));
      tabOption = t2._as(t1.getElementById("tabOption"));
      B.InputElement_methods.addEventListener$2(tabOption, "change", new A._registerListeners_closure0(tabOption));
    },
    _loadUiAndHideSpinner() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void);
      var $async$_loadUiAndHideSpinner = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 2;
              return A._asyncAwait(A._insertAppId(), $async$_loadUiAndHideSpinner);
            case 2:
              // returning from await.
              if ($async$result) {
                A._updateElementVisibility("appIdContainer", true);
                A._updateElementVisibility("appIdDivider", true);
              }
      ...
      return A._asyncStartSync($async$_loadUiAndHideSpinner, $async$completer);
    },
    _fetchDebugInfo(tabId) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.nullable_DebugInfo),
        $async$returnValue;
      var $async$_fetchDebugInfo = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$goto = 3;
              return A._asyncAwait(A.fetchStorageObject(tabId, B.StorageObject_0, type$.DebugInfo), $async$_fetchDebugInfo);
            case 3:
              // returning from await.
      ...
      return A._asyncStartSync($async$_fetchDebugInfo, $async$completer);
    },
    _insertAppId() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.bool),
        $async$returnValue, t1, t2, workspaceName, appIdSpan, tabId, debugInfo;
      var $async$_insertAppId = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 3;
              return A._asyncAwait(A._tabId(), $async$_insertAppId);
            case 3:
              // returning from await.
              tabId = $async$result;
              $async$goto = 4;
              return A._asyncAwait(A._fetchDebugInfo(tabId), $async$_insertAppId);
            case 4:
              // returning from await.
              ...
              if (t1 === true && workspaceName != null) {
                t1 = t2 === true ? "-f" : "";
                $._appId = workspaceName + "-" + A.S(tabId) + t1;
                appIdSpan = type$.SpanElement._as(document.getElementById("appId"));
                t1 = $._appId;
                B.SpanElement_methods.set$text(appIdSpan, null);
                appIdSpan.appendChild(B.SpanElement_methods.createFragment$3$treeSanitizer$validator(appIdSpan, t1, null, null)).toString;
      ...
      return A._asyncStartSync($async$_insertAppId, $async$completer);
    },
    _openIssueTracker(_) {
      return A._openIssueTracker$body(type$.Event._as(_));
    },
    _openIssueTracker$body(_) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        debugInfo, t1, $async$temp1;
      var $async$_openIssueTracker = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp1 = A;
              $async$goto = 3;
              return A._asyncAwait(A._tabId(), $async$_openIssueTracker);
            case 3:
              // returning from await.
              $async$goto = 2;
              return A._asyncAwait($async$temp1._fetchDebugInfo($async$result), $async$_openIssueTracker);
            case 2:
              // returning from await.
              debugInfo = $async$result;
              t1 = debugInfo == null ? null : debugInfo.isInternalBuild;
              $async$goto = 4;
              return A._asyncAwait(A.createTab(t1 === true ? "http://b/issues/new?component=775375&template=1791321" : "https://github.com/dart-lang/webdev/issues/new?labels=dart-debug-extension&projects=&template=dart_debug_extension.md"), $async$_openIssueTracker);
            case 4:
              // returning from await.
              // implicit return
              return A._asyncReturn(null, $async$completer);
      ...
      return A._asyncStartSync($async$_openIssueTracker, $async$completer);
    },
    _launchDevTools(_) {
      return A._launchDevTools$body(type$.Event._as(_));
    },
    _launchDevTools$body(_) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        tabId, t1, t2;
      var $async$_launchDevTools = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 2;
              return A._asyncAwait(A._tabId(), $async$_launchDevTools);
            case 2:
              // returning from await.
              tabId = $async$result;
              t1 = $.$get$serializers();
              t2 = new A.DebugStateChangeBuilder();
              type$.nullable_void_Function_DebugStateChangeBuilder._as(new A._launchDevTools_closure(tabId)).call$1(t2);
              $async$goto = 3;
              return A._asyncAwait(A._sendMessage(B.C_JsonCodec.encode$2$toEncodable(t1.serialize$1(t2._build$0()), null), B.Script_0, B.Script_4, B.MessageType_4), $async$_launchDevTools);
            case 3:
              // returning from await.
              // implicit return
              return A._asyncReturn(null, $async$completer);
      ...
      return A._asyncStartSync($async$_launchDevTools, $async$completer);
    },
    _copyAppId(_) {
      var t1, clipboard;
      type$.Event._as(_);
      ...
      if (clipboard == null)
        return;
      t1 = clipboard.writeText(t1);
      t1.toString;
      A.promiseToFuture(t1, type$.dynamic);
      A._updateElementVisibility("copiedSuccess", true);
    },
    _updateSettingsFromStorage(_) {
      return A._updateSettingsFromStorage$body(type$.Event._as(_));
    },
    _updateSettingsFromStorage$body(_) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        t2, devToolsOpener, t1, openInNewWindow;
      var $async$_updateSettingsFromStorage = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 2;
              return A._asyncAwait(A.fetchStorageObject(null, B.StorageObject_1, type$.DevToolsOpener), $async$_updateSettingsFromStorage);
            case 2:
              // returning from await.
              devToolsOpener = $async$result;
              t1 = devToolsOpener == null ? null : devToolsOpener.newWindow;
              openInNewWindow = t1 === true;
              t1 = document;
              t2 = type$.RadioButtonInputElement;
              B.InputElement_methods.set$checked(t2._as(t1.getElementById("windowOption")), openInNewWindow);
              B.InputElement_methods.set$checked(t2._as(t1.getElementById("tabOption")), !openInNewWindow);
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
      return A._asyncStartSync($async$_updateSettingsFromStorage, $async$completer);
    },
    _saveSettingsToStorage(devToolsOpener) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, t1;
      var $async$_saveSettingsToStorage = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              if (devToolsOpener == null) {
                // goto return
                $async$goto = 1;
                break;
              }
              t1 = new A.DevToolsOpenerBuilder();
              type$.nullable_void_Function_DevToolsOpenerBuilder._as(new A._saveSettingsToStorage_closure(devToolsOpener)).call$1(t1);
              $async$goto = 3;
              return A._asyncAwait(A.setStorageObject(B.StorageObject_1, t1._build$0(), type$.DevToolsOpener), $async$_saveSettingsToStorage);
            case 3:
              // returning from await.
            case 1:
              // return
      ...
      return A._asyncStartSync($async$_saveSettingsToStorage, $async$completer);
    },
    ...
    _registerListeners_closure: function _registerListeners_closure(t0) {
      this.windowOption = t0;
    },
    _registerListeners_closure0: function _registerListeners_closure0(t0) {
      this.tabOption = t0;
    },
    _launchDevTools_closure: function _launchDevTools_closure(t0) {
      this.tabId = t0;
    },
    _saveSettingsToStorage_closure: function _saveSettingsToStorage_closure(t0) {
      this.devToolsOpener = t0;
    },
    setStorageObject(type, value, $T) {
      var storageArea, t2,
        storageKey = A._createStorageKey(type, null),
        json = B.C_JsonCodec.encode$2$toEncodable($.$get$serializers().serialize$1(value), null),
        t1 = type$.String,
        storageObj = A.LinkedHashMap_LinkedHashMap$_literal([storageKey, json], t1, t1);
      t1 = new A._Future($.Zone__current, type$._Future_bool);
      storageArea = A._getStorageArea(type.get$persistence());
      t2 = A.jsify(storageObj);
      if (t2 == null)
        t2 = type$.Object._as(t2);
      J.$set$2$x(storageArea, t2, A.allowInterop(new A.setStorageObject_closure(null, json, storageKey, new A._AsyncCompleter(t1, type$._AsyncCompleter_bool)), type$.void_Function));
      return t1;
    },
    ...
    setStorageObject_closure: function setStorageObject_closure(t0, t1, t2, t3) {
      var _ = this;
      _.callback = t0;
      _.json = t1;
      _.storageKey = t2;
    ...
    createTab(url) {
      var t1 = new A._Future($.Zone__current, type$._Future_Tab),
        completer = new A._AsyncCompleter(t1, type$._AsyncCompleter_Tab);
      J.create$2$x(J.get$tabs$x(self.chrome), {active: true, url: url}, A.allowInterop(type$.void_Function_$opt_nullable_FutureOr_Tab._as(completer.get$complete(completer)), type$.void_Function_Tab));
      return t1;
    },
    activeTab() {
      var t1 = new A._Future($.Zone__current, type$._Future_nullable_Tab),
        query = {active: true, currentWindow: true};
      J.query$2$x(J.get$tabs$x(self.chrome), query, A.allowInterop(new A.activeTab_closure(new A._AsyncCompleter(t1, type$._AsyncCompleter_nullable_Tab)), type$.void_Function_List_Tab));
      return t1;
    },
    isDevMode() {
      var extensionName,
    ...
    activeTab_closure: function activeTab_closure(t0) {
      this.completer = t0;
    },
  ...
  A.DevToolsOpenerBuilder.prototype = {
    ...
    _build$0() {
      var t1, t2,
        ...
        _s9_ = "newWindow",
        _$result = this._data_types$_$v;
      if (_$result == null) {
        t1 = type$.bool;
        t2 = A.BuiltValueNullFieldError_checkNotNull(this.get$_data_types$_$this()._newWindow, _s14_, _s9_, t1);
      ...
      return this._data_types$_$v = _$result;
    }
  };
  ...
  A._sendMessage_responseHandler.prototype = {
    call$1(_) {
      var _this = this,
        ...
        t1 = error != null;
      if (t1)
        A._log("Error sending " + _this.type.toString$0(0) + " to " + _this.recipient.toString$0(0) + " from " + _this.sender.toString$0(0) + ": " + A.S(J.get$message$x(error)), B._LogLevel_2, null, false);
  ...
  A._registerListeners_closure.prototype = {
    call$1(_) {
      type$.Event._as(_);
      A._saveSettingsToStorage(this.windowOption.value);
    },
    $signature: 16
  };
  A._registerListeners_closure0.prototype = {
    call$1(_) {
      type$.Event._as(_);
      A._saveSettingsToStorage(this.tabOption.value);
    },
    $signature: 16
  };
  A._launchDevTools_closure.prototype = {
    call$1(b) {
      b.get$_data_types$_$this()._tabId = this.tabId;
      b.get$_data_types$_$this()._newState = "start-debugging";
      return b;
    },
    $signature: 45
  };
  A._saveSettingsToStorage_closure.prototype = {
    call$1(b) {
      b.get$_data_types$_$this()._newWindow = this.devToolsOpener === "window";
      return b;
    },
    $signature: 46
  };
  ...
  A.setStorageObject_closure.prototype = {
    call$0() {
      A._log("Set: " + this.json, null, this.storageKey, false);
  ...
  A.activeTab_closure.prototype = {
    call$1(tabs) {
      var t1, t2;
      type$.List_dynamic._as(tabs);
      t1 = J.getInterceptor$asx(tabs);
      t2 = this.completer;
      if (t1.get$isNotEmpty(tabs))
        t2.complete$1(0, type$.Tab._as(t1.get$first(tabs)));
      else
  ...
  (function installTearOffs() {
    ...
    _static_2(J, "_interceptors_JSArray__compareAny$closure", "JSArray__compareAny", 49);
    ...
    _instance(A._AsyncCompleter.prototype, "get$complete", 1, 0, function() {
      return [null];
    }, ["call$1", "call$0"], ["complete$1", "complete$0"], 25, 0, 0);
    ...
    _static_1(A, "popup___openIssueTracker$closure", "_openIssueTracker", 4);
    _static_1(A, "popup___launchDevTools$closure", "_launchDevTools", 4);
    _static_1(A, "popup___copyAppId$closure", "_copyAppId", 35);
    _static_1(A, "popup___updateSettingsFromStorage$closure", "_updateSettingsFromStorage", 4);
  })();
  (function inheritance() {
    ...
    _inheritMany(A.Closure0Args, [A._AsyncRun__scheduleImmediateJsOverride_internalCallback, A._AsyncRun__scheduleImmediateWithSetImmediate_internalCallback, A._TimerImpl_internalCallback, A._Future__addListener_closure, A._Future__prependListeners_closure, A._Future__chainForeignFuture_closure1, A._Future__chainCoreFutureAsync_closure, A._Future__asyncCompleteWithValue_closure, A._Future__asyncCompleteError_closure, A._Future__propagateToListeners_handleWhenCompleteCallback, A._Future__propagateToListeners_handleValueCallback, A._Future__propagateToListeners_handleError, A._rootHandleError_closure, A._RootZone_bindCallbackGuarded_closure, A.Serializers_Serializers_closure, A.Serializers_Serializers_closure0, A.Serializers_Serializers_closure1, A.Serializers_Serializers_closure2, A.Serializers_Serializers_closure3, A._$serializers_closure, A.setStorageObject_closure]);
    ...
    _inheritMany(A.HtmlElement, [A.AnchorElement, A.AreaElement, A.BaseElement, A.BodyElement, A.ButtonElement, A.FormElement, A.InputElement, A.SelectElement, A.SpanElement, A.TemplateElement]);
    ...
    _inheritMany(A._Enum, [A._LogLevel, A.Script, A.MessageType, A.StorageObject, A.Persistence]);
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      nullable_void_Function_DevToolsOpenerBuilder: findType("~(DevToolsOpenerBuilder)?"),
      num: findType("num"),
      void: findType("~"),
      void_Function: findType("~()"),
      void_Function_$opt_nullable_FutureOr_Tab: findType("~([Tab/?])"),
      void_Function_List_Tab: findType("~(List<Tab>)"),
      void_Function_Object: findType("~(Object)"),
      void_Function_String_String: findType("~(String,String)"),
      void_Function_String_dynamic: findType("~(String,@)"),
      void_Function_Tab: findType("~(Tab)")
    };
  })();
  (function constants() {
