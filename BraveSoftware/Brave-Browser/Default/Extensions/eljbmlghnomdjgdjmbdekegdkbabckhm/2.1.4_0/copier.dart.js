...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      J.addListener$1$x(J.get$onMessage$x(J.get$runtime$x(self.chrome)), A.allowInterop(A.copier___handleRuntimeMessages$closure(), type$.dynamic_Function_dynamic_MessageSender_Function));
    },
    _handleRuntimeMessages(jsRequest, sender, sendResponse) {
      type$.MessageSender._as(sender);
      type$.Function._as(sendResponse);
      A.interceptMessage(B.Script_1, B.Script_0, B.MessageType_2, A._asStringQ(jsRequest), A.copier___copyAppId$closure(), sender, type$.String);
      sendResponse.call$1($.$get$defaultResponse());
    },
    _copyAppId(appId) {
      var clipboard, t1;
      A._asString(appId);
      ...
      if (clipboard == null)
        return;
      t1 = clipboard.writeText(appId);
      t1.toString;
      A.promiseToFuture(t1, type$.dynamic);
      A._sendMessage(appId, B.Script_0, B.Script_1, B.MessageType_2);
    }
  },
  B = {};
  var holders = [A, J, B];
  ...
  (function installTearOffs() {
    ...
    _static(A, "copier___handleRuntimeMessages$closure", 3, null, ["call$3"], ["_handleRuntimeMessages"], 39, 0);
    _static_1(A, "copier___copyAppId$closure", "_copyAppId", 26);
  })();
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazyFinal($, "defaultResponse", "$get$defaultResponse", () => {
      var t1 = type$.String;
      return A.jsify(A.LinkedHashMap_LinkedHashMap$_literal(["response", "received"], t1, t1));
    });
  })();
...
//# sourceMappingURL=copier.dart.js.map
