// Generated by dart2js (NullSafetyMode.sound, csp, intern-composite-values), the Dart to JavaScript compiler version: 3.3.0-107.0.dev.
...
(function dartProgram() {
  ...
  var J = {
    ...
    connect$2$x(receiver, a0, a1) {
      return J.getInterceptor$x(receiver).connect$2(receiver, a0, a1);
    },
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    _log(msg, prefix, verbose) {
      var logMsg,
        t1 = A.isDevMode();
      if (!t1)
        return;
      logMsg = "[" + prefix + "] " + msg;
      switch (B._LogLevel_0) {
        case B._LogLevel_2:
    ...
    _InjectDetails: function _InjectDetails() {
    },
    ...
    main() {
      var date = new A.DateTime(Date.now(), false);
      A._log("Connecting to lifeline port at " + ("" + A.Primitives_getHours(date) + ":" + A.Primitives_getMinutes(date) + "::" + A.Primitives_getSeconds(date)) + ".", "Dart Debug Extension", false);
      J.connect$2$x(J.get$runtime$x(self.chrome), null, {name: "keepAlive"});
    }
  },
  B = {};
  var holders = [A, J, B];
  ...
  J.LegacyJavaScriptObject.prototype = {
    ...
    connect$2(receiver, p0, p1) {
      return receiver.connect(p0, p1);
    },
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.SentinelValue, A.Iterable, A.ListIterator, A.FixedLengthListMixin, A.Closure, A.MapBase, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.Rti, A._FunctionParameters, A._Type, A.ListBase, A.DateTime, A._Enum, A.Null, A.StringBuffer, A.CssStyleDeclarationBase, A.ImmutableListMixin, A.FixedSizeListIterator]);
...
//# sourceMappingURL=lifeline_connection.dart.js.map
