...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    _log(msg, level, prefix, verbose) {
      ...
      switch (level) {
        case B._LogLevel_2:
          J.error$1$x(self.console, msg);
          break;
        case B._LogLevel_1:
          J.warn$1$x(self.console, msg);
          break;
        case B._LogLevel_0:
          J.log$1$x(self.console, msg);
          break;
      }
    },
    ...
    main() {
      var t1 = document;
      t1.toString;
      B.HtmlDocument_methods.addEventListener$2(t1, "dart-app-ready", A.detector___onDartAppReadyEvent$closure());
      B.HtmlDocument_methods.addEventListener$2(t1, "dart-auth-response", A.detector___onDartAuthEvent$closure());
    },
    _onDartAppReadyEvent($event) {
      return A._onDartAppReadyEvent$body(type$.Event._as($event));
    },
    _onDartAppReadyEvent$body($event) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        t1, script, appOrigin, debugInfo;
      var $async$_onDartAppReadyEvent = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              debugInfo = A._asStringQ($event.detail);
              $async$goto = debugInfo == null ? 2 : 4;
              break;
            case 2:
              // then
              A._log("No debug info sent with ready event, instead reading from Window.", B._LogLevel_1, null, false);
              t1 = document;
              script = t1.createElement("script");
              script.setAttribute("src", J.getURL$1$x(J.get$runtime$x(self.chrome), "debug_info.dart.js"));
              script.setAttribute("defer", true);
              t1 = t1.head;
              if (t1 != null)
                t1.appendChild(script).toString;
              // goto join
              $async$goto = 3;
              break;
            case 4:
              // else
              $async$goto = 5;
              return A._asyncAwait(A._sendMessageToBackgroundScript(debugInfo, B.MessageType_3), $async$_onDartAppReadyEvent);
            case 5:
              // returning from await.
              debugInfo = type$.nullable_DebugInfo._as($.$get$serializers().deserialize$1(B.C_JsonCodec.decode$2$reviver(0, debugInfo, null)));
              appOrigin = debugInfo == null ? null : debugInfo.appOrigin;
              if (appOrigin != null) {
                t1 = window;
                t1.toString;
                B.Window_methods.postMessage$2(t1, "dart-auth-request", appOrigin);
              }
              A._detectMultipleDartApps();
            case 3:
              // join
              // implicit return
      ...
      return A._asyncStartSync($async$_onDartAppReadyEvent, $async$completer);
    },
    _onDartAuthEvent($event) {
      return A._onDartAuthEvent$body(type$.Event._as($event));
    },
    _onDartAuthEvent$body($event) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, isAuthenticated;
      var $async$_onDartAuthEvent = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              isAuthenticated = A._asStringQ($event.detail);
              ...
              $async$goto = 3;
              return A._asyncAwait(A._sendMessageToBackgroundScript(isAuthenticated, B.MessageType_0), $async$_onDartAuthEvent);
            case 3:
              // returning from await.
            case 1:
              // return
      ...
      return A._asyncStartSync($async$_onDartAuthEvent, $async$completer);
    },
    _detectMultipleDartApps() {
      var t1,
        _s23_ = "data-multiple-dart-apps",
        documentElement = document.documentElement;
      if (documentElement == null)
        return;
      t1 = documentElement.hasAttribute(_s23_);
      t1.toString;
      if (t1) {
        A._sendMessageToBackgroundScript("true", B.MessageType_6);
        return;
      }
      t1 = new (window.MutationObserver || window.WebKitMutationObserver || window.MozMutationObserver)(A.convertDartClosureToJS(A._wrapBinaryZone(A.detector___detectMultipleDartAppsCallback$closure(), type$.List_dynamic, type$.MutationObserver), 2));
      t1.toString;
      B.MutationObserver_methods.observe$2$attributeFilter(t1, documentElement, A._setArrayType([_s23_], type$.JSArray_String));
    },
    _detectMultipleDartAppsCallback(mutations, observer) {
      var t1;
      type$.List_dynamic._as(mutations);
      type$.MutationObserver._as(observer);
      for (t1 = J.get$iterator$ax(mutations); t1.moveNext$0();)
        if (A._isMultipleAppsMutation(t1.get$current(t1))) {
          A._sendMessageToBackgroundScript("true", B.MessageType_6);
          observer.disconnect();
        }
    },
    _isMultipleAppsMutation(mutation) {
      var isAttributeMutation,
        t1 = mutation == null,
        t2 = t1 ? type$.Object._as(mutation) : mutation;
      if ("type" in t2) {
        t2 = t1 ? type$.Object._as(mutation) : mutation;
        isAttributeMutation = J.$eq$(t2.type, "attributes");
      } else
        isAttributeMutation = false;
      if (isAttributeMutation) {
        t2 = t1 ? type$.Object._as(mutation) : mutation;
        if ("attributeName" in t2) {
          t1 = t1 ? type$.Object._as(mutation) : mutation;
          t1 = J.$eq$(t1.attributeName, "data-multiple-dart-apps");
        } else
          t1 = false;
        return t1;
      }
    ...
    _sendMessageToBackgroundScript(body, type) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void);
      var $async$_sendMessageToBackgroundScript = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 2;
              return A._asyncAwait(A._sendMessage(body, B.Script_0, B.Script_3, type), $async$_sendMessageToBackgroundScript);
            case 2:
              // returning from await.
              // implicit return
              return A._asyncReturn(null, $async$completer);
      ...
      return A._asyncStartSync($async$_sendMessageToBackgroundScript, $async$completer);
    }
  },
  B = {};
  var holders = [A, J, B];
  ...
  A.MutationObserver.prototype = {
    observe$2$attributeFilter(receiver, target, attributeFilter) {
      var parsedOptions, t1, _null = null;
      type$.nullable_List_String._as(attributeFilter);
      parsedOptions = {};
  ...
  (function installTearOffs() {
    ...
    _static_2(J, "_interceptors_JSArray__compareAny$closure", "JSArray__compareAny", 39);
    ...
    var _;
    _instance_2_u(_ = A.DeepCollectionEquality.prototype, "get$equals", "equals$2", 5);
    _instance_1_i(_, "get$hash", "hash$1", 7);
    _instance_1_u(_, "get$isValidKey", "isValidKey$1", 36);
    _static_1(A, "detector___onDartAppReadyEvent$closure", "_onDartAppReadyEvent", 9);
    _static_1(A, "detector___onDartAuthEvent$closure", "_onDartAuthEvent", 9);
    _static_2(A, "detector___detectMultipleDartAppsCallback$closure", "_detectMultipleDartAppsCallback", 28);
  })();
  (function inheritance() {
    ...
    _inheritMany(A._Enum, [A._LogLevel, A.Script, A.MessageType]);
...
//# sourceMappingURL=detector.dart.js.map
