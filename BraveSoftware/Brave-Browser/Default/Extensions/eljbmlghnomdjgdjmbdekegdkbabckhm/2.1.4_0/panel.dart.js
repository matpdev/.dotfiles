...
(function dartProgram() {
  ...
  var J = {
    ...
    get$lastError$x(receiver) {
      return J.getInterceptor$x(receiver).get$lastError(receiver);
    },
    ...
    get$notifications$x(receiver) {
      return J.getInterceptor$x(receiver).get$notifications(receiver);
    },
    get$onChanged$x(receiver) {
      return J.getInterceptor$x(receiver).get$onChanged(receiver);
    },
    get$onMessage$x(receiver) {
    ...
    get$themeName$x(receiver) {
      return J.getInterceptor$x(receiver).get$themeName(receiver);
    },
    $eq$(receiver, a0) {
      if (receiver == null)
        return a0 == null;
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    _Base64Encoder_encodeChunk(alphabet, bytes, start, end, isLast, output, outputIndex, state) {
      ...
      for (t1 = bytes.length, t2 = alphabet.length, t3 = output.length, i = start, byteOr = 0; i < end; ++i) {
        if (!(i < t1))
    ...
    _ChildrenElementList__addAll(_element, iterable) {
      var t1, t2, t3;
      for (t1 = iterable.get$iterator(0), t2 = t1.$ti._precomputed1; t1.moveNext$0();) {
        t3 = t1._current;
        _element.appendChild(t3 == null ? t2._as(t3) : t3).toString;
      }
    },
    ...
    Serializers_Serializers() {
      ...
      t3 = type$.Object;
      t2.add$1(0, new A.BuiltListSerializer(A.BuiltList_BuiltList$from([B.Type_BuiltList_27p, A.getRuntimeTypeOfDartObject(A.BuiltList_BuiltList$from(B.List_empty0, t3))], t1)));
      ...
      t2.add$1(0, new A.BuiltSetSerializer(A.BuiltList_BuiltList$from([B.Type_BuiltSet_MMh, A.getRuntimeTypeOfDartObject(A.BuiltSet_BuiltSet$from(B.List_empty0, t3))], t1)));
    ...
    ExternalExtensionMessage: function ExternalExtensionMessage() {
    },
    DebugEvent: function DebugEvent() {
    },
    SendCommandOptions: function SendCommandOptions() {
    },
    ErrorResponse: function ErrorResponse() {
    },
    _$serializers_closure: function _$serializers_closure() {
    },
    _$DebugStateChange__$DebugStateChange(updates) {
      var t1 = new A.DebugStateChangeBuilder();
      type$.nullable_void_Function_DebugStateChangeBuilder._as(updates).call$1(t1);
      return t1._data_types$_build$0();
    },
    ...
    _debugSessionForTab(tabId, type) {
      switch (type) {
        case B.TabType_0:
          return A.IterableExtension_firstWhereOrNull($._debugSessions, new A._debugSessionForTab_closure(tabId), type$._DebugSession);
        case B.TabType_1:
          return A.IterableExtension_firstWhereOrNull($._debugSessions, new A._debugSessionForTab_closure0(tabId), type$._DebugSession);
      }
    },
    DetachReason: function DetachReason(t0) {
      this._name = t0;
    },
    ConnectFailureReason: function ConnectFailureReason(t0) {
      this._name = t0;
    },
    TabType: function TabType(t0) {
      this._name = t0;
    },
    _debugSessionForTab_closure: function _debugSessionForTab_closure(t0) {
      this.tabId = t0;
    },
    _debugSessionForTab_closure0: function _debugSessionForTab_closure0(t0) {
      this.tabId = t0;
    },
    EmptyParam: function EmptyParam() {
    },
    _EvalResponse: function _EvalResponse() {
    },
    _EvalResult: function _EvalResult() {
    },
    _InjectedParams: function _InjectedParams() {
    },
    debugError(msg) {
      A._log(msg, B._LogLevel_2, null, false);
    },
    _log(msg, level, prefix, verbose) {
      var logMsg;
      if (!verbose && !A.isDevMode())
        return;
    ...
    interceptMessage(expectedRecipient, expectedSender, expectedType, message, messageHandler, sender, $T) {
      var decodedMessage, error, decoded, t1, t2, exception;
      if (!A._isLegitimateSender(sender))
        return;
      try {
        decoded = type$.Map_String_dynamic._as(B.C_JsonCodec.decode$2$reviver(0, message, null));
        t1 = J.getInterceptor$asx(decoded);
        t2 = type$.Script;
        decodedMessage = new A.Message(A.EnumByName_byName(B.List_4QF, A._asString(t1.$index(decoded, "to")), t2), A.EnumByName_byName(B.List_4QF, A._asString(t1.$index(decoded, "from")), t2), A.EnumByName_byName(B.List_2Vk, A._asString(t1.$index(decoded, "type")), type$.MessageType), A._asString(t1.$index(decoded, "body")), A._asStringQ(t1.$index(decoded, "error")));
        if (decodedMessage.type !== expectedType || decodedMessage.to !== expectedRecipient || decodedMessage.from !== expectedSender)
          return;
        if (A.createRuntimeType($T) === B.Type_String_J2O)
          messageHandler.call$1($T._as(decodedMessage.body));
        else
          messageHandler.call$1($T._as($.$get$serializers().deserialize$1(B.C_JsonCodec.decode$2$reviver(0, decodedMessage.body, null))));
      } catch (exception) {
        error = A.unwrapException(exception);
        A.debugError("Error intercepting " + expectedType.toString$0(0) + " from " + expectedSender.toString$0(0) + " to " + expectedRecipient.toString$0(0) + ": " + A.S(error));
      }
    },
    _sendMessage(body, recipient, sender, type) {
      var message,
        t1 = A.LinkedHashMap_LinkedHashMap$_empty(type$.String, type$.nullable_String);
      t1.$indexSet(0, "to", recipient._name);
      t1.$indexSet(0, "from", sender._name);
      t1.$indexSet(0, "type", type._name);
      t1.$indexSet(0, "body", body);
      message = B.C_JsonCodec.encode$2$toEncodable(t1, null);
      t1 = new A._Future($.Zone__current, type$._Future_bool);
      J.sendMessage$4$x(J.get$runtime$x(self.chrome), null, message, null, A.allowInterop(new A._sendMessage_responseHandler(type, recipient, sender, new A._AsyncCompleter(t1, type$._AsyncCompleter_bool)), type$.Function));
      return t1;
    },
    _isLegitimateSender(sender) {
      var t2, senderUri, senderHost, isDartAppHost, isExtensionOrigin,
        t1 = J.getInterceptor$x(sender);
      if (!J.$eq$(t1.get$id(sender), J.get$id$x(J.get$runtime$x(self.chrome))))
        return false;
      t2 = t1.get$origin(sender);
      senderUri = A.Uri_parse(t2 == null ? "" : t2);
      senderHost = senderUri.get$host(senderUri);
      isDartAppHost = senderHost === "localhost" || senderHost === "127.0.0.1" || A._isGoogleHost(senderHost);
      isExtensionOrigin = senderHost === J.get$id$x(J.get$runtime$x(self.chrome)) && senderUri.get$scheme() === "chrome-extension";
      if (isDartAppHost || isExtensionOrigin)
        return true;
      t1 = A.S(t1.get$origin(sender));
      t2 = J.get$notifications$x(self.chrome);
      J.create$3$x(t2, null, {title: "[Error] Dart Debug Extension", message: "Unexpected sender " + t1 + ". Please file a bug at go/dde-bug or https://github.com/dart-lang/webdev", iconUrl: "static_assets/dart_warning.png", type: "basic"}, null);
      return false;
    },
    _isGoogleHost(host) {
      return B.JSArray_methods.any$1(B.List_oyn, new A._isGoogleHost_closure(host));
    },
    ...
    _sendMessage_responseHandler: function _sendMessage_responseHandler(t0, t1, t2, t3) {
      var _ = this;
      _.type = t0;
      _.recipient = t1;
      _.sender = t2;
    ...
    _isGoogleHost_closure: function _isGoogleHost_closure(t0) {
      this.host = t0;
    },
    main() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        chromeTheme, panelBody, $async$temp1;
      var $async$main = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              A._registerListeners().catchError$1(new A.main_closure());
              chromeTheme = J.get$themeName$x(J.get$panels$x(J.get$devtools$x(self.chrome)));
              panelBody = document.getElementById("panelBody");
              if (chromeTheme === "dark") {
                $._backgroundColor = "202125";
                A._updateColorThemeForElement(panelBody, true);
              } else {
                $._backgroundColor = "ffffff";
                A._updateColorThemeForElement(panelBody, false);
              }
              $async$goto = 2;
              return A._asyncAwait(A._maybeUpdateFileABugLink(), $async$main);
            case 2:
              // returning from await.
              $async$temp1 = A;
              $async$goto = 3;
              return A._asyncAwait(A.fetchStorageObject(J.get$tabId$x(J.get$inspectedWindow$x(J.get$devtools$x(self.chrome))), B.StorageObject_5, type$.String), $async$main);
            case 3:
              // returning from await.
              $async$temp1._maybeShowMultipleAppsWarning($async$result);
              // implicit return
    ...
    _registerListeners() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void);
      var $async$_registerListeners = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              J.addListener$1$x(J.get$onChanged$x(J.get$storage$x(self.chrome)), A.allowInterop(A.panel___handleStorageChanges$closure(), type$.void_Function_Object_String));
              J.addListener$1$x(J.get$onMessage$x(J.get$runtime$x(self.chrome)), A.allowInterop(A.panel___handleRuntimeMessages$closure(), type$.dynamic_Function_dynamic_MessageSender_Function));
              B.ButtonElement_methods._addEventListener$3(type$.ButtonElement._as(document.getElementById("launchDebugConnectionButton")), "click", type$.nullable_dynamic_Function_Event._as(A.panel___launchDebugConnection$closure()), null);
              $async$goto = 2;
              return A._asyncAwait(A._maybeInjectDevToolsIframe(), $async$_registerListeners);
            case 2:
              // returning from await.
              // implicit return
              return A._asyncReturn(null, $async$completer);
      ...
      return A._asyncStartSync($async$_registerListeners, $async$completer);
    },
    _handleRuntimeMessages(jsRequest, sender, sendResponse) {
      type$.MessageSender._as(sender);
      type$.Function._as(sendResponse);
      if (typeof jsRequest != "string")
        return;
      A.interceptMessage(B.Script_2, B.Script_0, B.MessageType_4, jsRequest, new A._handleRuntimeMessages_closure(), sender, type$.DebugStateChange);
      A.interceptMessage(B.Script_2, B.Script_0, B.MessageType_1, jsRequest, new A._handleRuntimeMessages_closure0(), sender, type$.ConnectFailure);
    },
    _handleStorageChanges(storageObj, _) {
      var t1;
      type$.Object._as(storageObj);
      A._asString(_);
      A.interceptStorageChange(A.panel___handleDebugInfoChanges$closure(), B.StorageObject_0, storageObj, J.get$tabId$x(J.get$inspectedWindow$x(J.get$devtools$x(self.chrome))), type$.DebugInfo);
      t1 = type$.String;
      A.interceptStorageChange(A.panel___handleDevToolsUriChanges$closure(), B.StorageObject_2, storageObj, J.get$tabId$x(J.get$inspectedWindow$x(J.get$devtools$x(self.chrome))), t1);
      A.interceptStorageChange(A.panel___maybeShowMultipleAppsWarning$closure(), B.StorageObject_5, storageObj, J.get$tabId$x(J.get$inspectedWindow$x(J.get$devtools$x(self.chrome))), t1);
    },
    _handleDebugInfoChanges(debugInfo) {
      var t1 = type$.nullable_DebugInfo._as(debugInfo) == null;
      if (t1 && $._isDartApp) {
        $._isDartApp = false;
        if (!A._warningBannerIsVisible(null))
          A._showWarningBanner("No app detected.");
      }
      if (!t1 && !$._isDartApp) {
        $._isDartApp = true;
        if (A._warningBannerIsVisible(null))
          A._hideWarningBanner();
      }
    },
    _handleDevToolsUriChanges(devToolsUri) {
      A._asStringQ(devToolsUri);
      if (devToolsUri != null)
        A._injectDevToolsIframe(devToolsUri);
    },
    _maybeShowMultipleAppsWarning(multipleApps) {
      var _s37_ = "Cannot debug multiple apps in a page.";
      if (A._asStringQ(multipleApps) != null)
        A._showWarningBanner(_s37_);
      else if (A._warningBannerIsVisible(_s37_))
        A._hideWarningBanner();
    },
    _maybeUpdateFileABugLink() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, bugLink, debugInfo, t1;
      var $async$_maybeUpdateFileABugLink = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 3;
              return A._asyncAwait(A.fetchStorageObject(J.get$tabId$x(J.get$inspectedWindow$x(J.get$devtools$x(self.chrome))), B.StorageObject_0, type$.DebugInfo), $async$_maybeUpdateFileABugLink);
            case 3:
              // returning from await.
              debugInfo = $async$result;
              t1 = debugInfo == null ? null : debugInfo.isInternalBuild;
              if (t1 === true) {
      ...
      return A._asyncStartSync($async$_maybeUpdateFileABugLink, $async$completer);
    },
    _updateColorThemeForElement(element, isDarkTheme) {
      var classToRemove, t1, classToAdd,
        _s11_ = "light-theme",
        _s10_ = "dark-theme";
      if (element == null)
        return;
      classToRemove = isDarkTheme ? _s11_ : _s10_;
      t1 = J.getInterceptor$x(element);
      if (t1.get$classes(element).contains$1(0, classToRemove)) {
        t1.get$classes(element).remove$1(0, classToRemove);
        classToAdd = isDarkTheme ? _s10_ : _s11_;
        t1.get$classes(element).add$1(0, classToAdd);
      }
    },
    _handleDebugConnectionLost(reason) {
      var t1 = reason == null ? "unknown" : reason;
      t1 = A.EnumByName_byName(B.List_gQW, t1, type$.DetachReason);
      A._removeDevToolsIframe();
      A._updateElementVisibility("landingPage", true);
      switch (t1) {
        case B.DetachReason_0:
          return;
        case B.DetachReason_5:
        case B.DetachReason_4:
          A._showWarningBanner("No app detected.");
          break;
        default:
          A._showWarningBanner("Lost connection.");
          break;
      }
    },
    _handleConnectFailure(reason) {
      switch (reason) {
        case B.ConnectFailureReason_0:
          A._showWarningBanner("Please re-authenticate and try again.");
          break;
        case B.ConnectFailureReason_1:
          A._showWarningBanner("No app detected.");
          break;
        case B.ConnectFailureReason_2:
          A._showWarningBanner("Connection timed out.");
          break;
        default:
          A._showWarningBanner("Failed to connect, please try again.");
      }
      A._updateElementVisibility("launchDebugConnectionButton", true);
      A._updateElementVisibility("loadingSpinner", false);
    },
    _warningBannerIsVisible(message) {
      var warningMsg,
        t1 = document,
        warningBanner = t1.getElementById("warningBanner"),
        isVisible = warningBanner != null && J.get$classes$x(warningBanner).contains$1(0, "show");
      if (message == null || !isVisible)
        return isVisible;
      warningMsg = t1.getElementById("warningMsg");
      return (warningMsg == null ? null : J.get$innerHtml$x(warningMsg)) == message;
    },
    _showWarningBanner(message) {
      var warningBanner,
        ...
        warningMsg = t1.getElementById("warningMsg");
      if (warningMsg != null)
        J.setInnerHtml$1$x(warningMsg, message);
      warningBanner = t1.getElementById("warningBanner");
      if (warningBanner != null)
        J.get$classes$x(warningBanner).add$1(0, "show");
    },
    _hideWarningBanner() {
      var warningBanner = document.getElementById("warningBanner");
      if (warningBanner != null)
        J.get$classes$x(warningBanner).remove$1(0, "show");
    },
    _launchDebugConnection(_) {
      return A._launchDebugConnection$body(type$.Event._as(_));
    },
    _launchDebugConnection$body(_) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void);
      var $async$_launchDebugConnection = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              A._updateElementVisibility("launchDebugConnectionButton", false);
              A._updateElementVisibility("loadingSpinner", true);
              $async$goto = 2;
              return A._asyncAwait(A._sendMessage(B.C_JsonCodec.encode$2$toEncodable($.$get$serializers().serialize$1(A._$DebugStateChange__$DebugStateChange(new A._launchDebugConnection_closure())), null), B.Script_0, B.Script_2, B.MessageType_4), $async$_launchDebugConnection);
            case 2:
              // returning from await.
              A._maybeHandleConnectionTimeout().catchError$1(new A._launchDebugConnection_closure0());
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
      return A._asyncStartSync($async$_launchDebugConnection, $async$completer);
    },
    _maybeHandleConnectionTimeout() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void);
      var $async$_maybeHandleConnectionTimeout = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $._connecting = true;
              $async$goto = 2;
              return A._asyncAwait(A.Future_Future$delayed(A.Duration$(0, 10), type$.dynamic), $async$_maybeHandleConnectionTimeout);
            case 2:
              // returning from await.
              if ($._connecting)
                A._handleConnectFailure(B.ConnectFailureReason_2);
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
      return A._asyncStartSync($async$_maybeHandleConnectionTimeout, $async$completer);
    },
    _maybeInjectDevToolsIframe() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, devToolsUri;
      var $async$_maybeInjectDevToolsIframe = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 3;
              return A._asyncAwait(A.fetchStorageObject(J.get$tabId$x(J.get$inspectedWindow$x(J.get$devtools$x(self.chrome))), B.StorageObject_2, type$.String), $async$_maybeInjectDevToolsIframe);
            case 3:
              // returning from await.
              devToolsUri = $async$result;
              if (devToolsUri == null) {
                // goto return
                $async$goto = 1;
                break;
              }
              A._debugSessionForTab(J.get$tabId$x(J.get$inspectedWindow$x(J.get$devtools$x(self.chrome))), B.TabType_0);
              A._injectDevToolsIframe(devToolsUri);
            case 1:
              // return
              return A._asyncReturn($async$returnValue, $async$completer);
      ...
      return A._asyncStartSync($async$_maybeInjectDevToolsIframe, $async$completer);
    },
    _injectDevToolsIframe(devToolsUri) {
      var t1, iframeContainer, panelBody, panelType, iframe, t2, originalUri, t3;
      $._connecting = false;
      t1 = document;
      iframeContainer = t1.getElementById("iframeContainer");
      if (iframeContainer == null)
        return;
      panelBody = t1.getElementById("panelBody");
      panelType = panelBody == null ? null : panelBody.getAttribute("data-panel");
      if (panelType == null)
        panelType = "debugger";
      iframe = t1.createElement("iframe");
      t1 = type$.String;
      t2 = A.LinkedHashMap_LinkedHashMap$_literal(["ide", "ChromeDevTools", "embed", "true", "page", panelType, "backgroundColor", $._backgroundColor], t1, t1);
      originalUri = A.Uri_parse(devToolsUri);
      t3 = originalUri.get$queryParameters();
      t1 = A.LinkedHashMap_LinkedHashMap(t1, type$.dynamic);
      t1.addAll$1(0, t3);
      t1.addAll$1(0, t2);
      iframe.setAttribute("src", originalUri.replace$2$path$queryParameters(0, "", t1).get$_text());
      A._hideWarningBanner();
      A._updateElementVisibility("landingPage", false);
      A._updateElementVisibility("loadingSpinner", false);
      A._updateElementVisibility("launchDebugConnectionButton", true);
      iframeContainer.appendChild(iframe).toString;
    },
    _removeDevToolsIframe() {
      var iframeContainer = document.getElementById("iframeContainer"),
        iframe = iframeContainer == null ? null : iframeContainer.firstChild;
      if (iframe == null)
        return;
      J.remove$0$ax(iframe);
    },
    _updateElementVisibility(elementId, visible) {
      var t1,
      ...
      t1 = J.getInterceptor$x(element);
      if (visible)
        t1.get$classes(element).remove$1(0, "hidden");
      else
        t1.get$classes(element).add$1(0, "hidden");
    },
    main_closure: function main_closure() {
    },
    _handleRuntimeMessages_closure: function _handleRuntimeMessages_closure() {
    },
    _handleRuntimeMessages_closure0: function _handleRuntimeMessages_closure0() {
    },
    _launchDebugConnection_closure: function _launchDebugConnection_closure() {
    },
    _launchDebugConnection_closure0: function _launchDebugConnection_closure0() {
    },
    ...
    interceptStorageChange(changeHandler, expectedType, storageObj, tabId, $T) {
      var expectedStorageKey, isExpected, objProp, json, decodedObj, error, t1, t2, exception;
      try {
        expectedStorageKey = A._createStorageKey(expectedType, tabId);
        isExpected = expectedStorageKey in storageObj;
        if (!A.boolConversionCheck(isExpected))
          return;
        objProp = storageObj[expectedStorageKey];
        t1 = objProp;
        if (t1 == null)
          t1 = type$.Object._as(t1);
        json = A._asStringQ(t1.newValue);
        decodedObj = null;
        t1 = json == null || A.createRuntimeType($T) === B.Type_String_J2O;
        t2 = $T._eval$1("0?");
        if (t1)
          decodedObj = t2._as(json);
        else
          decodedObj = t2._as($.$get$serializers().deserialize$1(B.C_JsonCodec.decode$2$reviver(0, json, null)));
        A._log("Intercepted " + A.S(expectedStorageKey) + " change: " + A.S(json), null, null, false);
        t1 = changeHandler.call$1(decodedObj);
        return t1;
      } catch (exception) {
        error = A.unwrapException(exception);
        A.debugError("Error intercepting storage object with type " + expectedType.toString$0(0) + ": " + A.S(error));
      }
    },
  ...
  J.LegacyJavaScriptObject.prototype = {
    ...
    get$themeName(obj) {
      return obj.themeName;
    },
    create$3(receiver, p0, p1, p2) {
      return receiver.create(p0, p1, p2);
    },
    sendMessage$4(receiver, p0, p1, p2, p3) {
  ...
  A._CastIterableBase.prototype = {
    get$iterator(_) {
      ...
      return new A.CastIterator(J.get$iterator$ax(this._source), t1._eval$1("@<1>")._bind$1(t1._rest[1])._eval$1("CastIterator<1,2>"));
    },
    get$length(_) {
    ...
    elementAt$1(_, index) {
      return A._instanceType(this)._rest[1]._as(J.elementAt$1$ax(this._source, index));
    },
    contains$1(_, other) {
  ...
  A._ElementCssClassSet.prototype = {
    ...
    contains$1(_, value) {
      var t1;
      if (typeof value == "string") {
        t1 = this._html$_element.classList.contains(value);
        t1.toString;
      } else
        t1 = false;
      return t1;
  ...
  A.SvgElement.prototype = {
    ...
    get$innerHtml(receiver) {
      ...
      A._ChildrenElementList__addAll(t1, type$.Iterable_Element._as(new A.FilteredElementList(cloned, new A._ChildNodeListLazy(cloned))));
      return t1.innerHTML;
    },
  ...
  A.BuiltListMultimap.prototype = {
    ...
    $eq(_, other) {
      ...
      if (other.get$hashCode(0) !== _this.get$hashCode(0))
        return false;
      for (t3 = _this.get$keys(0), t4 = t3._map, t3 = A.LinkedHashMapKeyIterator$(t4, t4._modifications, t3.$ti._precomputed1), t4 = other._emptyList, t5 = _this._emptyList; t3.moveNext$0();) {
  ...
  A.BuiltMap.prototype = {
    ...
    $eq(_, other) {
      ...
      if (other.get$hashCode(0) !== _this.get$hashCode(0))
        return false;
      for (t3 = _this.get$keys(0), t4 = t3._map, t3 = A.LinkedHashMapKeyIterator$(t4, t4._modifications, t3.$ti._precomputed1); t3.moveNext$0();) {
        key = t3.__js_helper$_current;
  ...
  A.BuiltSet.prototype = {
    get$hashCode(_) {
      ...
      if (t1 == null) {
        t1 = _this._set$_set;
        t2 = A._instanceType(t1);
        t3 = t2._eval$1("EfficientLengthMappedIterable<SetBase.E,int>");
        t3 = A.List_List$of(new A.EfficientLengthMappedIterable(t1, t2._eval$1("int(SetBase.E)")._as(new A.BuiltSet_hashCode_closure(_this)), t3), false, t3._eval$1("Iterable.E"));
    ...
    map$1$1(_, f, $T) {
      var t1 = this._set$_set,
        t2 = A._instanceType(t1);
      return new A.EfficientLengthMappedIterable(t1, t2._bind$1($T)._eval$1("1(SetBase.E)")._as(this.$ti._bind$1($T)._eval$1("1(2)")._as(f)), t2._eval$1("@<SetBase.E>")._bind$1($T)._eval$1("EfficientLengthMappedIterable<1,2>"));
    },
    map$1(_, f) {
      return this.map$1$1(0, f, type$.dynamic);
    },
  ...
  A.SetBuilder.prototype = {
    ...
    map$1(_, f) {
      ...
      t3 = t1._precomputed1;
      t4 = A._instanceType(t2);
      result.addAll$1(0, new A.EfficientLengthMappedIterable(t2, t4._bind$1(t3)._eval$1("1(SetBase.E)")._as(f), t4._eval$1("@<SetBase.E>")._bind$1(t3)._eval$1("EfficientLengthMappedIterable<1,2>")));
  ...
  A.BuiltSetMultimap.prototype = {
    ...
    $eq(_, other) {
      ...
      if (other.get$hashCode(0) !== _this.get$hashCode(0))
        return false;
      for (t3 = _this.get$keys(0), t4 = t3._map, t3 = A.LinkedHashMapKeyIterator$(t4, t4._modifications, t3.$ti._precomputed1), t4 = other._emptySet, t5 = _this._emptySet; t3.moveNext$0();) {
        key = t3.__js_helper$_current;
        result = t1.$index(0, key);
        t6 = result == null ? t4 : result;
        result = t2.$index(0, key);
  ...
  A.BuiltListMultimapSerializer.prototype = {
    serialize$3$specifiedType(serializers, builtListMultimap, specifiedType) {
      ...
      result = [];
      for (t1 = builtListMultimap.get$keys(0), t2 = t1._map, t1 = A.LinkedHashMapKeyIterator$(t2, t2._modifications, t1.$ti._precomputed1), t2 = builtListMultimap._list_multimap$_map, t3 = builtListMultimap._emptyList; t1.moveNext$0();) {
        key = t1.__js_helper$_current;
  ...
  A.BuiltMapSerializer.prototype = {
    serialize$3$specifiedType(serializers, builtMap, specifiedType) {
      ...
      result = [];
      for (t1 = builtMap.get$keys(0), t2 = t1._map, t1 = A.LinkedHashMapKeyIterator$(t2, t2._modifications, t1.$ti._precomputed1), t2 = builtMap._map$_map; t1.moveNext$0();) {
        key = t1.__js_helper$_current;
        result.push(serializers.serialize$2$specifiedType(key, keyType));
  ...
  A.BuiltSetMultimapSerializer.prototype = {
    serialize$3$specifiedType(serializers, builtSetMultimap, specifiedType) {
      ...
      result = [];
      for (t1 = builtSetMultimap.get$keys(0), t2 = t1._map, t1 = A.LinkedHashMapKeyIterator$(t2, t2._modifications, t1.$ti._precomputed1), t2 = builtSetMultimap._set_multimap$_map, t3 = builtSetMultimap._emptySet; t1.moveNext$0();) {
        key = t1.__js_helper$_current;
        result.push(serializers.serialize$2$specifiedType(key, keyType));
        result0 = t2.$index(0, key);
        t4 = result0 == null ? t3 : result0;
        ...
        t7 = t6._eval$1("EfficientLengthMappedIterable<SetBase.E,Object?>");
        result.push(A.List_List$of(new A.EfficientLengthMappedIterable(t5, t6._eval$1("Object?(SetBase.E)")._as(t4.$ti._eval$1("Object?(1)")._as(new A.BuiltSetMultimapSerializer_serialize_closure(serializers, valueType))), t7), true, t7._eval$1("Iterable.E")));
      }
      return result;
    },
  ...
  A.BuiltSetSerializer.prototype = {
    serialize$3$specifiedType(serializers, builtSet, specifiedType) {
      ...
      t2 = A._instanceType(t1);
      return new A.EfficientLengthMappedIterable(t1, t2._eval$1("Object?(SetBase.E)")._as(builtSet.$ti._eval$1("Object?(1)")._as(new A.BuiltSetSerializer_serialize_closure(serializers, elementType))), t2._eval$1("EfficientLengthMappedIterable<SetBase.E,Object?>"));
    },
  ...
  A.DateTimeSerializer.prototype = {
    serialize$3$specifiedType(serializers, dateTime, specifiedType) {
      ...
      return 1000 * dateTime._core$_value;
    },
  ...
  A.DeepCollectionEquality.prototype = {
    equals$2(e1, e2) {
      var t1, _this = this;
      if (e1 instanceof A.SetBase)
        return e2 instanceof A.SetBase && new A.SetEquality(_this, type$.SetEquality_dynamic).equals$2(e1, e2);
  ...
  A._$DebugInfoSerializer.prototype = {
    serialize$3$specifiedType(serializers, object, specifiedType) {
      ...
      if (value != null) {
        result.push("tabId");
        result.push(serializers.serialize$2$specifiedType(value, B.FullType_xEI));
      }
      return result;
    },
  ...
  A._$DevToolsRequestSerializer.prototype = {
    serialize$3$specifiedType(serializers, object, specifiedType) {
      ...
      result = ["appId", serializers.serialize$2$specifiedType(object.appId, B.FullType_iHz), "instanceId", serializers.serialize$2$specifiedType(object.instanceId, B.FullType_iHz)];
  ...
  A._$ExtensionRequestSerializer.prototype = {
    serialize$3$specifiedType(serializers, object, specifiedType) {
      ...
      result = ["id", serializers.serialize$2$specifiedType(object.id, B.FullType_xEI), "command", serializers.serialize$2$specifiedType(object.command, B.FullType_iHz)];
  ...
  A._$ExtensionResponseSerializer.prototype = {
    serialize$3$specifiedType(serializers, object, specifiedType) {
      ...
      result = ["id", serializers.serialize$2$specifiedType(object.id, B.FullType_xEI), "success", serializers.serialize$2$specifiedType(object.success, B.FullType_mpw), "result", serializers.serialize$2$specifiedType(object.result, B.FullType_iHz)];
      value = object.error;
      if (value != null) {
        result.push("error");
        result.push(serializers.serialize$2$specifiedType(value, B.FullType_iHz));
  ...
  A._$ExtensionEventSerializer.prototype = {
    serialize$3$specifiedType(serializers, object, specifiedType) {
      ...
      return ["params", serializers.serialize$2$specifiedType(object.params, B.FullType_iHz), "method", serializers.serialize$2$specifiedType(object.method, B.FullType_iHz)];
    },
    serialize$2(serializers, object) {
      return this.serialize$3$specifiedType(serializers, object, B.FullType_null_List_empty_false);
    },
  ...
  A._$BatchedEventsSerializer.prototype = {
    serialize$3$specifiedType(serializers, object, specifiedType) {
      return ["events", serializers.serialize$2$specifiedType(type$.BatchedEvents._as(object).events, B.FullType_zVP)];
    },
    serialize$2(serializers, object) {
      return this.serialize$3$specifiedType(serializers, object, B.FullType_null_List_empty_false);
    },
  ...
  A.ExtensionEventBuilder.prototype = {
    ...
    _build$0() {
      ...
      if (_$result == null) {
        t1 = type$.String;
        t2 = A.BuiltValueNullFieldError_checkNotNull(_this.get$_$this()._params, _s14_, "params", t1);
        t3 = A.BuiltValueNullFieldError_checkNotNull(_this.get$_$this()._extension_request$_method, _s14_, "method", t1);
  ...
  A.ExternalExtensionMessage.prototype = {};
  A.DebugEvent.prototype = {};
  A.SendCommandOptions.prototype = {};
  ...
  A._$ConnectFailureSerializer.prototype = {
    serialize$3$specifiedType(serializers, object, specifiedType) {
      var result, value;
      type$.ConnectFailure._as(object);
      result = ["tabId", serializers.serialize$2$specifiedType(object.tabId, B.FullType_xEI)];
      value = object.reason;
      if (value != null) {
        result.push("reason");
        result.push(serializers.serialize$2$specifiedType(value, B.FullType_iHz));
  ...
  A._$DevToolsOpenerSerializer.prototype = {
    serialize$3$specifiedType(serializers, object, specifiedType) {
      return ["newWindow", serializers.serialize$2$specifiedType(type$.DevToolsOpener._as(object).newWindow, B.FullType_mpw)];
    },
    serialize$2(serializers, object) {
      return this.serialize$3$specifiedType(serializers, object, B.FullType_null_List_empty_false);
    },
  ...
  A._$DevToolsUrlSerializer.prototype = {
    serialize$3$specifiedType(serializers, object, specifiedType) {
      type$.DevToolsUrl._as(object);
      return ["tabId", serializers.serialize$2$specifiedType(object.tabId, B.FullType_xEI), "url", serializers.serialize$2$specifiedType(object.url, B.FullType_iHz)];
    },
    serialize$2(serializers, object) {
      return this.serialize$3$specifiedType(serializers, object, B.FullType_null_List_empty_false);
    },
  ...
  A._$DebugStateChangeSerializer.prototype = {
    serialize$3$specifiedType(serializers, object, specifiedType) {
      var result, value;
      type$.DebugStateChange._as(object);
      result = ["tabId", serializers.serialize$2$specifiedType(object.tabId, B.FullType_xEI), "newState", serializers.serialize$2$specifiedType(object.newState, B.FullType_iHz)];
      value = object.reason;
      if (value != null) {
        result.push("reason");
        result.push(serializers.serialize$2$specifiedType(value, B.FullType_iHz));
    ...
    deserialize$3$specifiedType(serializers, serialized, specifiedType) {
      ...
      return result._data_types$_build$0();
    },
    deserialize$2(serializers, serialized) {
      return this.deserialize$3$specifiedType(serializers, serialized, B.FullType_null_List_empty_false);
    },
  ...
  A.DebugStateChangeBuilder.prototype = {
    ...
    _data_types$_build$0() {
      var t1, t2, t3, t4, _this = this,
        _s16_ = "DebugStateChange",
        _s8_ = "newState",
        _$result = _this._data_types$_$v;
      if (_$result == null) {
        t1 = type$.int;
        t2 = A.BuiltValueNullFieldError_checkNotNull(_this.get$_data_types$_$this()._tabId, _s16_, "tabId", t1);
        t3 = type$.String;
        t4 = A.BuiltValueNullFieldError_checkNotNull(_this.get$_data_types$_$this()._newState, _s16_, _s8_, t3);
        _$result = new A._$DebugStateChange(t2, t4, _this.get$_data_types$_$this()._reason);
      ...
      return _this._data_types$_$v = _$result;
    }
  };
  A.DetachReason.prototype = {
    _enumToString$0() {
      return "DetachReason." + this._name;
    }
  };
  A.ConnectFailureReason.prototype = {
    _enumToString$0() {
      return "ConnectFailureReason." + this._name;
    }
  };
  A.TabType.prototype = {
    _enumToString$0() {
      return "TabType." + this._name;
    }
  };
  A._debugSessionForTab_closure.prototype = {
    call$1(session) {
      type$._DebugSession._as(session).get$appTabId();
      return false;
    },
    $signature: 18
  };
  A._debugSessionForTab_closure0.prototype = {
    call$1(session) {
      type$._DebugSession._as(session).get$devToolsTabId();
      return false;
    },
    $signature: 18
  };
  A.EmptyParam.prototype = {};
  A._EvalResponse.prototype = {};
  A._EvalResult.prototype = {};
  A._InjectedParams.prototype = {};
  ...
  A.Message.prototype = {};
  A._sendMessage_responseHandler.prototype = {
    call$1(_) {
      var _this = this,
        error = J.get$lastError$x(J.get$runtime$x(self.chrome)),
        t1 = error != null;
      if (t1)
        A.debugError("Error sending " + _this.type.toString$0(0) + " to " + _this.recipient.toString$0(0) + " from " + _this.sender.toString$0(0) + ": " + A.S(J.get$message$x(error)));
  ...
  A._isGoogleHost_closure.prototype = {
    call$1(suffix) {
      return B.JSString_methods.endsWith$1(this.host, A._asString(suffix));
    },
    $signature: 5
  };
  A.main_closure.prototype = {
    call$1(error) {
      A._log("Error registering listeners in panel: " + A.S(error), B._LogLevel_1, null, false);
    },
    $signature: 4
  };
  A._handleRuntimeMessages_closure.prototype = {
    call$1(debugStateChange) {
      return this.$call$body$_handleRuntimeMessages_closure0(type$.DebugStateChange._as(debugStateChange));
    },
    $call$body$_handleRuntimeMessages_closure0(debugStateChange) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue;
      var $async$call$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              if (debugStateChange.tabId !== J.get$tabId$x(J.get$inspectedWindow$x(J.get$devtools$x(self.chrome)))) {
                A._log("Received debug state change request, but Dart app tab does not match current tab.", B._LogLevel_1, null, false);
                // goto return
                $async$goto = 1;
                break;
              }
              if (debugStateChange.newState === "stop-debugging")
                A._handleDebugConnectionLost(debugStateChange.reason);
            case 1:
              // return
              return A._asyncReturn($async$returnValue, $async$completer);
          }
  ...
  A._handleRuntimeMessages_closure0.prototype = {
    call$1(connectFailure) {
      return this.$call$body$_handleRuntimeMessages_closure(type$.ConnectFailure._as(connectFailure));
    },
    $call$body$_handleRuntimeMessages_closure(connectFailure) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
      ...
      var $async$call$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = connectFailure.tabId;
              A._log("Received connect failure for " + t1 + " vs " + A.S(J.get$tabId$x(J.get$inspectedWindow$x(J.get$devtools$x(self.chrome)))), null, null, false);
              if (t1 !== J.get$tabId$x(J.get$inspectedWindow$x(J.get$devtools$x(self.chrome)))) {
                // goto return
                $async$goto = 1;
                break;
              }
              $._connecting = false;
              t1 = connectFailure.reason;
              if (t1 == null)
                t1 = "unknown";
              A._handleConnectFailure(A.EnumByName_byName(B.List_0nC, t1, type$.ConnectFailureReason));
            case 1:
              // return
              return A._asyncReturn($async$returnValue, $async$completer);
          }
  ...
  A._launchDebugConnection_closure.prototype = {
    call$1(b) {
      var t1 = J.get$tabId$x(J.get$inspectedWindow$x(J.get$devtools$x(self.chrome)));
      b.get$_data_types$_$this()._tabId = t1;
      b.get$_data_types$_$this()._newState = "start-debugging";
      return b;
    },
    $signature: 51
  };
  A._launchDebugConnection_closure0.prototype = {
    call$1(_) {
    },
    $signature: 4
  };
  ...
  (function installTearOffs() {
    ...
    _static_2(J, "_interceptors_JSArray__compareAny$closure", "JSArray__compareAny", 53);
    ...
    _static_1(A, "collection___defaultHashCode$closure", "_defaultHashCode", 7);
    _static_1(A, "convert___defaultToEncodable$closure", "_defaultToEncodable", 3);
    _static_1(A, "core__identityHashCode$closure", "identityHashCode", 7);
    ...
    _instance_1_i(_, "get$hash", "hash$1", 7);
    _instance_1_u(_, "get$isValidKey", "isValidKey$1", 45);
    _static(A, "panel___handleRuntimeMessages$closure", 3, null, ["call$3"], ["_handleRuntimeMessages"], 56, 0);
    _static_2(A, "panel___handleStorageChanges$closure", "_handleStorageChanges", 57);
    _static_1(A, "panel___handleDebugInfoChanges$closure", "_handleDebugInfoChanges", 58);
    _static_1(A, "panel___handleDevToolsUriChanges$closure", "_handleDevToolsUriChanges", 9);
    _static_1(A, "panel___maybeShowMultipleAppsWarning$closure", "_maybeShowMultipleAppsWarning", 9);
    _static_1(A, "panel___launchDebugConnection$closure", "_launchDebugConnection", 40);
  })();
  (function inheritance() {
    ...
    _inheritMany(J.LegacyJavaScriptObject, [J.PlainJavaScriptObject, J.UnknownJavaScriptObject, J.JavaScriptFunction, A._FetchOptions, A.Chrome, A.Commands, A.OnCommandHandler, A.Debugger, A.OnDetachHandler, A.OnEventHandler, A.Debuggee, A.Devtools, A.InspectedWindow, A.Panels, A.ExtensionPanel, A.OnHiddenHandler, A.OnShownHandler, A.Notifications, A.OnClickedHandler, A.NotificationOptions, A.Runtime, A.ChromeError, A.ConnectInfo, A.Port, A.OnPortMessageHandler, A.ConnectionHandler, A.OnMessageHandler, A.MessageSender, A.Target, A.Storage0, A.StorageArea, A.OnChangedHandler, A.Tabs, A.OnActivatedHandler, A.OnRemovedHandler, A.ActiveInfo0, A.TabInfo, A.QueryInfo, A.Tab, A.WebNavigation, A.OnCommittedHandler, A.NavigationInfo, A.Windows, A.OnFocusChangedHandler, A.WindowInfo, A.WindowObj, A.ExternalExtensionMessage, A.DebugEvent, A.SendCommandOptions, A.ErrorResponse, A.EmptyParam, A._EvalResponse, A._EvalResult, A._InjectedParams, A._Console, A.IconInfo, A.PopupDetails, A.Json, A.FetchOptions]);
    _inherit(J.JSUnmodifiableArray, J.JSArray);
    _inheritMany(J.JSNumber, [J.JSInt, J.JSNumNotInt]);
    _inheritMany(A.Iterable, [A._CastIterableBase, A.EfficientLengthIterable, A.MappedIterable, A.WhereIterable, A._KeysOrValues]);
    ...
    _inheritMany(A.ListBase, [A.UnmodifiableListBase, A._ChildNodeListLazy, A.FilteredElementList]);
    ...
    _inheritMany(A.Closure0Args, [A._AsyncRun__scheduleImmediateJsOverride_internalCallback, A._AsyncRun__scheduleImmediateWithSetImmediate_internalCallback, A._TimerImpl_internalCallback, A.Future_Future$delayed_closure, A._Future__addListener_closure, A._Future__prependListeners_closure, A._Future__chainForeignFuture_closure1, A._Future__chainCoreFutureAsync_closure, A._Future__asyncCompleteWithValue_closure, A._Future__asyncCompleteError_closure, A._Future__propagateToListeners_handleWhenCompleteCallback, A._Future__propagateToListeners_handleValueCallback, A._Future__propagateToListeners_handleError, A._rootHandleError_closure, A._RootZone_bindCallbackGuarded_closure, A._Utf8Decoder__decoder_closure, A._Utf8Decoder__decoderNonfatal_closure, A.Serializers_Serializers_closure, A.Serializers_Serializers_closure0, A.Serializers_Serializers_closure1, A.Serializers_Serializers_closure2, A.Serializers_Serializers_closure3, A._$serializers_closure]);
    ...
    _inheritMany(A.Converter, [A.Base64Encoder, A.Base64Decoder, A.JsonEncoder, A.JsonDecoder, A.Utf8Encoder, A.Utf8Decoder]);
    ...
    _inheritMany(A._Enum, [A.DetachReason, A.ConnectFailureReason, A.TabType, A._LogLevel, A.Script, A.MessageType, A.StorageObject, A.Persistence]);
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      ConnectFailureReason: findType("ConnectFailureReason"),
      ...
      DetachReason: findType("DetachReason"),
      ...
      MessageSender: findType("MessageSender"),
      MessageType: findType("MessageType"),
      ...
      _DebugSession: findType("_DebugSession"),
      ...
      dynamic_Function_dynamic_MessageSender_Function: findType("@(@,MessageSender,Function)"),
      int: findType("int"),
      legacy_Never: findType("0&*"),
      legacy_Object: findType("Object*"),
      nullable_DebugInfo: findType("DebugInfo?"),
      ...
      nullable_void_Function_DebugStateChangeBuilder: findType("~(DebugStateChangeBuilder)?"),
      num: findType("num"),
      void: findType("~"),
...
;
    ...
    B.ConnectFailureReason_0 = new A.ConnectFailureReason("authentication");
    B.ConnectFailureReason_1 = new A.ConnectFailureReason("noDartApp");
    B.ConnectFailureReason_2 = new A.ConnectFailureReason("timeout");
    B.DetachReason_0 = new A.DetachReason("canceledByUser");
    B.DetachReason_4 = new A.DetachReason("navigatedAwayFromApp");
    B.DetachReason_5 = new A.DetachReason("staleDebugSession");
    ...
    B.FullType_Dj3 = new A.FullType(B.Type_Object_QJv, B.List_empty1, false);
    ...
    B.FullType_iHz = new A.FullType(B.Type_String_J2O, B.List_empty1, false);
    B.Type_bool_RoS = A.typeLiteral("bool");
    B.FullType_mpw = new A.FullType(B.Type_bool_RoS, B.List_empty1, false);
    ...
    B.FullType_xEI = new A.FullType(B.Type_int_8nG, B.List_empty1, false);
    B.Type_ExtensionEvent_6Rj = A.typeLiteral("ExtensionEvent");
    B.FullType_6nc = new A.FullType(B.Type_ExtensionEvent_6Rj, B.List_empty1, false);
    ...
    B.ConnectFailureReason_3 = new A.ConnectFailureReason("unknown");
    B.List_0nC = A._setArrayType(makeConstList([B.ConnectFailureReason_0, B.ConnectFailureReason_1, B.ConnectFailureReason_2, B.ConnectFailureReason_3]), A.findType("JSArray<ConnectFailureReason>"));
    B.MessageType_0 = new A.MessageType("isAuthenticated");
    B.MessageType_1 = new A.MessageType("connectFailure");
    B.MessageType_2 = new A.MessageType("appId");
    B.MessageType_3 = new A.MessageType("debugInfo");
    B.MessageType_4 = new A.MessageType("debugStateChange");
    B.MessageType_5 = new A.MessageType("devToolsUrl");
    B.MessageType_6 = new A.MessageType("multipleAppsDetected");
    B.List_2Vk = A._setArrayType(makeConstList([B.MessageType_0, B.MessageType_1, B.MessageType_2, B.MessageType_3, B.MessageType_4, B.MessageType_5, B.MessageType_6]), A.findType("JSArray<MessageType>"));
    ...
    B.Script_0 = new A.Script("background");
    B.Script_1 = new A.Script("copier");
    B.Script_2 = new A.Script("debuggerPanel");
    B.Script_3 = new A.Script("detector");
    B.Script_4 = new A.Script("popup");
    B.List_4QF = A._setArrayType(makeConstList([B.Script_0, B.Script_1, B.Script_2, B.Script_3, B.Script_4]), A.findType("JSArray<Script>"));
    ...
    B.DetachReason_1 = new A.DetachReason("connectionErrorEvent");
    B.DetachReason_2 = new A.DetachReason("connectionDoneEvent");
    B.DetachReason_3 = new A.DetachReason("devToolsTabClosed");
    B.DetachReason_6 = new A.DetachReason("unknown");
    B.List_gQW = A._setArrayType(makeConstList([B.DetachReason_0, B.DetachReason_1, B.DetachReason_2, B.DetachReason_3, B.DetachReason_4, B.DetachReason_5, B.DetachReason_6]), A.findType("JSArray<DetachReason>"));
    ...
    B.List_oyn = A._setArrayType(makeConstList([".googlers.com", ".google.com", ".googleprod.com"]), type$.JSArray_String);
    ...
    B.TabType_0 = new A.TabType("dartApp");
    B.TabType_1 = new A.TabType("devTools");
  ...
  (function staticFields() {
    ...
    $._debugSessions = A._setArrayType([], A.findType("JSArray<_DebugSession>"));
    $._connecting = false;
    $._backgroundColor = "202125";
    $._isDartApp = true;
    $._isDevMode = null;
  ...
  (function lazyInitializers() {
    ...
    _lazyFinal($, "CssClassSetImpl__validTokenRE", "$get$CssClassSetImpl__validTokenRE", () => A.RegExp_RegExp("^\\S+$", true));
...
//# sourceMappingURL=panel.dart.js.map
